      ...
      <div className="container mx-auto px-6 py-8">
        ...
        <div className="mb-12 animate-fade-in">
          <h1 className="text-4xl md:text-5xl font-bold mb-4">
            Bem-vindo ao <span className="text-gradient">OpsHub</span>
          </h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
          ...
          <div className="animate-slide-up" style={{ animationDelay: "0.3s" }}>
            <StatCard
              ...
              icon={ClipboardCheck}
              trend="neutral"
              trendValue={`${Math.round((presentToday / employees.length) * 100)}%`}
            />
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="animate-slide-up" style={{ animationDelay: "0.5s" }}>
              <QuickAccessCard
                ...
                description="Gerencie funcionários, cargos e departamentos"
                icon={Users}
                path="/rh"
                color="primary"
              />
            ...
            <div className="animate-slide-up" style={{ animationDelay: "0.6s" }}>
              <QuickAccessCard
                ...
                description="Controle de ponto e frequência da equipe"
                icon={ClipboardList}
                path="/presenca"
                color="info"
              />
            ...
            <div className="animate-slide-up" style={{ animationDelay: "0.7s" }}>
              <QuickAccessCard
                title="Matriz RACI"
                description="Responsabilidades e atribuições de tarefas"
                icon={Grid3X3}
                path="/matriz"
                color="success"
              />
