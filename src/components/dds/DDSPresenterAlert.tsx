...
const DDSPresenterAlert = () => {
  ...
  return (
    <Card className="relative border-2 border-blue-400/50 bg-gradient-to-r from-blue-50/50 to-indigo-50/50 dark:from-blue-950/20 dark:to-indigo-950/20 overflow-hidden animate-fade-in">
      {/* Animated pulse border */}
      <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-blue-400 via-indigo-500 to-purple-500 animate-pulse" />
