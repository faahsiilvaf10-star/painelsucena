    ...
    <Popover>
      <PopoverTrigger asChild>
        <Button
          variant="ghost"
          size="icon"
          className="relative hover:bg-amber-500/10 group/bell"
        >
          <Bell className="h-5 w-5 text-amber-500 transition-transform group-hover/bell:scale-110" />
          {unreadCount > 0 && (
            <Badge
              variant="destructive"
              className="absolute -top-1 -right-1 h-5 min-w-[20px] flex items-center justify-center p-1 text-[10px] font-bold animate-pulse border-2 border-background"
            >
