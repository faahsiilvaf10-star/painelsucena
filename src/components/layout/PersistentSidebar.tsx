      ...
      >
        ...
        >
          ...
          <div className="relative z-10 flex-1 flex flex-col min-w-0 h-full overflow-hidden">
            <SidebarTrigger className="fixed top-4 left-4 z-[101] md:hidden bg-sidebar-accent/90 backdrop-blur shadow-sm border border-sidebar-border/50 text-sidebar-foreground" />
            {children}
          </div>
        </div>
