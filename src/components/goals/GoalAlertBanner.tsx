...
export function GoalAlertBanner() {
  ...
  const gabiaoGoals: GoalStatus[] = [
    ...
    },
    {
      ...
      achieved: progress.escavacao_manual_unidade.percentage >= 100,
      team: "Encarregado II e sua Equipe",
    },
    {
      ...
      achieved: progress.reposicao_manta_unidade.percentage >= 100,
      team: "Encarregado II e sua Equipe",
    },
    {
      ...
      achieved: progress.reposicao_silte_unidade.percentage >= 100,
      team: "Encarregado II e sua Equipe",
    },
  ].filter(g => g.target > 0);
